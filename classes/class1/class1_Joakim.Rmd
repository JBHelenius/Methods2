...
knitr::opts_knit$set(root.dir = "/Users/jbhel/Documents/Methods2/classes")
...
```{r}
set.seed(2002) # setting a seed (in the best year ever??) - this way, even though it's random, you'll get reproducible results next time you run this with this seed

# rnorm() works like: my_simulated_data <- rnorm(n, mean, sd) - now you go!

# your code here
my_simulated_data <- rnorm(100, 50, 5)
df <- as.data.frame(my_simulated_data)
ggplot(df, aes(x=my_simulated_data)) + geom_histogram()
